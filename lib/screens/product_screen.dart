          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Align(
                ...
                child: _product.description.isEmpty
                    ? const Text('Nenhuma descrição fornecida')
              ...
              UserData.currentUser == ''
                  ? const Text('Entre ou cadastre-se para comprar!')
                  : ElevatedButton.icon(
                ...
                TextButton(
                    onPressed: () {
                      ...
                      Order newOrder = Order(
                          ...
                          orderProductsQty: <Product, int>{product: quantity});
